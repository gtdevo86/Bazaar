    ...
    public partial class initial : DbMigration
    {
        public override void Up()
        {
            CreateTable(
                ...
                c => new
                    {
                        ListingId = c.String(nullable: false, maxLength: 450),
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Listing", "OwnerId", "dbo.AspNetUsers");
            DropForeignKey("dbo.Listing", "BuyerId", "dbo.AspNetUsers");
            ...
            DropIndex("dbo.Listing", new[] { "BuyerId" });
            DropIndex("dbo.Listing", new[] { "OwnerId" });
